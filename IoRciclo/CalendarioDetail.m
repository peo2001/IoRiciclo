    ...
    if (aDictionary != NULL && [aDictionary count] > 0) {
        ...
        NSMutableArray *resultArray = [[NSMutableArray alloc] init];
            for (NSDictionary *currentResult in aDictionary)
            {
                ...
                cal.idcalendariodetail = [NSNumber numberWithInt:[[currentResult objectForKey:@"idcd"] integerValue]];
                cal.idcalendario =[NSNumber numberWithInt:[[currentResult objectForKey:@"idcal"] integerValue]];
