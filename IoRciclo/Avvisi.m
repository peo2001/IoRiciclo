    ...
    if (aDictionary != NULL && [aDictionary count] > 0) {
        ...
        if (presents != NULL)
        {
            ...
            for (NSDictionary *currentResult in presents)
            {
                ...
                avviso.idavviso = [NSNumber numberWithInt:[[currentResult objectForKey:@"idav"] integerValue]];
                avviso.idcomune = [NSNumber numberWithInt:[[currentResult objectForKey:@"idcom"] integerValue]];
