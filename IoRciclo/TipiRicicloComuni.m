    ...
    if (aDictionary != NULL && [aDictionary count] > 0) {
        ...
        if (presents != NULL)
        {
            ...
            for (NSDictionary *currentResult in presents)
            {
                ...
                tiporiciclocomune.idcomune = [NSNumber numberWithInt:[[currentResult objectForKey:@"idcomune"] integerValue]];
                tiporiciclocomune.idtiporiciclocomune =[NSNumber numberWithInt:[[currentResult objectForKey:@"idtiporiciclocomune"] integerValue]];
