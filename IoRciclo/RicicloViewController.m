...
- (void)createToolbar {
    ...
    NSArray *buttonItems = [NSArray arrayWithObjects: comune,flexibleSpace,alarm, nil];
    ...
    if (!alarmViewReady)
    {
      ...
      //  NSLog(@"ora %d",[MyApplicationSingleton getOraNotifica]);
       // NSLog(@"minuti %d",[MyApplicationSingleton getMinutiNotifica]);
        ...
        toolbar.tintColor= [UIColor whiteColor];//[UIColor colorWithRed:50.0f/255.0f green:170.0f/255.0f blue:40.0f/255.0f alpha:0.5f];
