    ...
    if (aDictionary != NULL && [aDictionary count] > 0) {
        ...
        if (presents != NULL)
        {
            ...
            for (NSDictionary *currentResult in presents)
            {
                ...
                zona.idzona = [NSNumber numberWithInt:[[currentResult objectForKey:@"idzona"] integerValue]] ;
                zona.idcomune = [NSNumber numberWithInt:[[currentResult objectForKey:@"idcomune"] integerValue]] ;
