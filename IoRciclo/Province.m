    ...
    if (aDictionary != NULL && [aDictionary count] > 0) {
        ...
        if (presents != NULL)
        {
            ...
            for (NSDictionary *currentResult in presents)
            {
                ...
                provincia.idprovincia = [NSNumber numberWithInt:[[currentResult objectForKey:@"idprovincia"] integerValue]];
                provincia.idregione =[NSNumber numberWithInt:[[currentResult objectForKey:@"idregione"] integerValue]];
